...
const Form: React.FC<FormProp> = () => {
   return (
      <div className="h-full w-full absolute z-10 bg-gray-700 bg-opacity-50">
         <form className="form-wrapper p-6 bg-white shadow-md rounded-lg mx-auto border-t-2 border-indigo-500 border-solid transform -translate-x-8 translate-y-16">
            ...
            <div className="mb-4">
               ...
               <input className="shadow-sm appearance-none border rounded text-xs w-full py-2 px-3 text-gray-700 leading-tight" id="task" type="text" />
            </div>
            <div className="mb-4">
               <label className="block text-gray-700 text-sm mb-2" htmlFor="comment">
               Comment
               </label>
               <textarea className="shadow-sm appearance-none border rounded w-full h-20 text-xs py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"></textarea>
            </div>
            ...
            <div className="due max-w-sm flex flex-wrap items-center">
               ...
               <div className="mb-2 mr-4">
                  <input className="shadow-sm appearance-none border rounded w-20 py-2 px-3 text-gray-700 leading-tight" id="date" type="text" placeholder="yy/mm/dd" />
               </div>
               <div className="mb-2">
                  <input className="shadow-sm appearance-none border rounded w-16 py-2 px-3 text-gray-700 leading-tight" id="time" type="text" placeholder="hh:mm" />
               </div>
            </div>
