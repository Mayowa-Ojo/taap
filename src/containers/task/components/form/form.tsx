...
const Form: React.FC<FormProp> = ({ toggleModal }) => {
   ...
   return (
      ...
      <form onSubmit={handleSubmit} className="form-wrapper pt-2 p-6 bg-white shadow-md rounded-lg mx-auto border-t-2 border-indigo-500 border-solid transform -translate-x-8 translate-y-16">
         <p className="text-xs text-center text-red-300">*press alt + left arrow{"[<-]"} to close</p>
