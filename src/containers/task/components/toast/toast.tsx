...
const Toast: React.FC<ToastProp> = (props) => {
   ...
   return (
      <div ref={ref} className={`toast ${props.isOpen ? "visible" : "invisible"} h-32 bg-white z-10 absolute shadow-md border border-gray-300 border-solid`}>
         <div className="h-4">
         ...
         <ul>
            ...
            { props.status !== "in-progress" && <li onClick={handleToastAction} className="text-gray-600 pl-2 border-b border-gray-200 border-solid hover:bg-gray-300 cursor-pointer">Mark as In-progress</li> }
            { props.status !== "completed" && <li onClick={handleToastAction} className="text-gray-600 pl-2 border-b border-gray-200 border-solid hover:bg-gray-300 cursor-pointer">Mark as Completed</li> }
            { props.status !== "unfulfilled" && <li onClick={handleToastAction} className="text-gray-600 pl-2 border-b border-gray-200 border-solid hover:bg-gray-300 cursor-pointer">Mark as Unfulfilled</li> }
